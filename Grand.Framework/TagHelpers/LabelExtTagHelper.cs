...
namespace Grand.Framework.TagHelpers
{
    ...
    [HtmlTargetElement("label-ext", Attributes = ForAttributeName)]
    public class LabelExtRequiredTagHelper : LabelTagHelper
    {
        ...
        public LabelExtRequiredTagHelper(IHtmlGenerator generator, IWorkContext workContext, ILocalizationService localizationService) : base(generator)
        {
