...
namespace Grand.Framework.TagHelpers
{
    ...
    [HtmlTargetElement("select-box", Attributes = ForAttributeName)]
    public class SelectBoxTagHelper : Microsoft.AspNetCore.Mvc.TagHelpers.SelectTagHelper
    {
        ...
        public SelectBoxTagHelper(IHtmlGenerator generator, IWorkContext workContext, ILocalizationService localizationService) : base(generator)
        {
