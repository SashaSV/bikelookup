using Grand.Framework.TagHelpers.Admin;
...
namespace Grand.Framework.TagHelpers
{
    ...
    /// input tag helper
    /// </summary>
    [HtmlTargetElement("input-form", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class InputFormTagHelper : TagHelper
    {
        ...
        public InputFormTagHelper(IHtmlHelper htmlHelper)
        {
